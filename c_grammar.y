...
const			: int_const
			...
			| enumeration_const
			;
preprocessor_directive : '#' 'include' STRING
                       | '#' 'define'  ID value
                       | '#' 'ifdef'   ID
                       | '#' 'ifndef'  ID
                       | '#' 'else'
...
value                  : constant
                       | STRING
                       ;
attribute              : '__attribute__' '(' '(' attribute_list ')' ')'
                       ;
...
attribute_item         : ID
                       ;
assembly               : '__asm' STRING
                       ;
builtin_function       : '__builtin_' ID '(' argument_expression_list ')'
                       ;
error_statement        : 'error' '(' STRING ')'
                       ;
type_spec              : ...
                       | 'struct' ID '{' member_list '}'
                       | 'union'  ID '{' member_list '}'
